...
public class InstrumentDetail {
  ...
  @SerializedName("ShortTradeDisabled")
  private Boolean shortTradeDisabled = null;

  @SerializedName("StandardAmounts")
  private List<Long> standardAmounts = null;

  @SerializedName("SupportedOrderTriggerPriceTypes")
  private List<Object> supportedOrderTriggerPriceTypes = null;
  ...
  public InstrumentDetail affiliateInfoRequired(Boolean affiliateInfoRequired) {
  ...
  **/
  ...
  public InstrumentDetail amountDecimals(Long amountDecimals) {
  ...
  **/
  ...
  public InstrumentDetail assetType(String assetType) {
  ...
  **/
  ...
  public InstrumentDetail currencyCode(String currencyCode) {
  ...
  **/
  ...
  public InstrumentDetail defaultAmount(BigDecimal defaultAmount) {
  ...
  **/
  ...
  public InstrumentDetail defaultSlippage(BigDecimal defaultSlippage) {
  ...
  **/
  ...
  public InstrumentDetail defaultSlippageType(String defaultSlippageType) {
  ...
  **/
  ...
  public InstrumentDetail description(String description) {
  ...
  **/
  ...
  public InstrumentDetail exchange(InstrumentsDetailsExchange exchange) {
  ...
  **/
  ...
  public InstrumentDetail format(InstrumentsDetailsFormat format) {
    this.format = format;
    return this;
  }
  ...
  **/
  ...
  public InstrumentDetail groupId(Long groupId) {
  ...
  **/
  ...
  public InstrumentDetail incrementSize(Long incrementSize) {
  ...
  **/
  ...
  public InstrumentDetail isBarrierEqualsStrike(Boolean isBarrierEqualsStrike) {
  ...
  **/
  ...
  public InstrumentDetail isComplex(Boolean isComplex) {
  ...
  **/
  ...
  public InstrumentDetail isExtendedTradingHoursEnabled(Boolean isExtendedTradingHoursEnabled) {
  ...
  **/
  ...
  public InstrumentDetail isPEAEligible(Boolean isPEAEligible) {
  ...
  **/
  ...
  public InstrumentDetail isPEASMEEligible(Boolean isPEASMEEligible) {
  ...
  **/
  ...
  public InstrumentDetail isRedemptionByAmounts(Boolean isRedemptionByAmounts) {
  ...
  **/
  ...
  public InstrumentDetail isSwitchBySameCurrency(Boolean isSwitchBySameCurrency) {
  ...
  **/
  ...
  public InstrumentDetail isTradable(Boolean isTradable) {
  ...
  **/
  ...
  public InstrumentDetail lotSizeType(String lotSizeType) {
  ...
  **/
  ...
  public InstrumentDetail minimumTradeSize(Long minimumTradeSize) {
  ...
  **/
  ...
  public InstrumentDetail nonTradableReason(String nonTradableReason) {
  ...
  **/
  ...
  public InstrumentDetail orderDistances(InstrumentsDetailsOrderDistances orderDistances) {
  ...
  **/
  ...
  public InstrumentDetail priceCurrency(String priceCurrency) {
  ...
  **/
  ...
  public InstrumentDetail priceToContractFactor(BigDecimal priceToContractFactor) {
  ...
  **/
  ...
  public InstrumentDetail primaryListing(Long primaryListing) {
  ...
  **/
  ...
  public InstrumentDetail relatedInstruments(List<InstrumentsDetailsRelatedInstruments> relatedInstruments) {
    this.relatedInstruments = relatedInstruments;
    return this;
  }

  public InstrumentDetail addRelatedInstrumentsItem(InstrumentsDetailsRelatedInstruments relatedInstrumentsItem) {
  ...
  **/
  ...
  public InstrumentDetail shortTradeDisabled(Boolean shortTradeDisabled) {
    this.shortTradeDisabled = shortTradeDisabled;
    return this;
  }

   /**
   * Get shortTradeDisabled
   * @return shortTradeDisabled
  **/
  @Schema(description = "")
  public Boolean isShortTradeDisabled() {
    return shortTradeDisabled;
  }

  public void setShortTradeDisabled(Boolean shortTradeDisabled) {
    this.shortTradeDisabled = shortTradeDisabled;
  }

  public InstrumentDetail standardAmounts(List<Long> standardAmounts) {
    this.standardAmounts = standardAmounts;
    return this;
  }

  public InstrumentDetail addStandardAmountsItem(Long standardAmountsItem) {
  ...
  **/
  ...
  public InstrumentDetail supportedOrderTriggerPriceTypes(List<Object> supportedOrderTriggerPriceTypes) {
    this.supportedOrderTriggerPriceTypes = supportedOrderTriggerPriceTypes;
    return this;
  }

  public InstrumentDetail addSupportedOrderTriggerPriceTypesItem(Object supportedOrderTriggerPriceTypesItem) {
    if (this.supportedOrderTriggerPriceTypes == null) {
      this.supportedOrderTriggerPriceTypes = new ArrayList<Object>();
    }
  ...
  **/
  @Schema(description = "")
  public List<Object> getSupportedOrderTriggerPriceTypes() {
    return supportedOrderTriggerPriceTypes;
  }

  public void setSupportedOrderTriggerPriceTypes(List<Object> supportedOrderTriggerPriceTypes) {
    this.supportedOrderTriggerPriceTypes = supportedOrderTriggerPriceTypes;
  }

  public InstrumentDetail supportedOrderTypes(List<String> supportedOrderTypes) {
    this.supportedOrderTypes = supportedOrderTypes;
    return this;
  }

  public InstrumentDetail addSupportedOrderTypesItem(String supportedOrderTypesItem) {
  ...
  **/
  ...
  public InstrumentDetail supportedStrategies(List<String> supportedStrategies) {
    this.supportedStrategies = supportedStrategies;
    return this;
  }

  public InstrumentDetail addSupportedStrategiesItem(String supportedStrategiesItem) {
  ...
  **/
  ...
  public InstrumentDetail symbol(String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  **/
  ...
  public InstrumentDetail tickSizeScheme(InstrumentsDetailsTickSizeScheme tickSizeScheme) {
  ...
  **/
  ...
  public InstrumentDetail tradableAs(List<String> tradableAs) {
    this.tradableAs = tradableAs;
    return this;
  }

  public InstrumentDetail addTradableAsItem(String tradableAsItem) {
  ...
  **/
  ...
  public InstrumentDetail tradableOn(List<String> tradableOn) {
    this.tradableOn = tradableOn;
    return this;
  }

  public InstrumentDetail addTradableOnItem(String tradableOnItem) {
  ...
  **/
  ...
  public InstrumentDetail tradingSignals(String tradingSignals) {
  ...
  **/
  ...
  public InstrumentDetail tradingStatus(String tradingStatus) {
  ...
  **/
  ...
  public InstrumentDetail uic(Long uic) {
    this.uic = uic;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InstrumentDetail instrumentDetail = (InstrumentDetail) o;
    return Objects.equals(this.affiliateInfoRequired, instrumentDetail.affiliateInfoRequired) &&
        Objects.equals(this.amountDecimals, instrumentDetail.amountDecimals) &&
        Objects.equals(this.assetType, instrumentDetail.assetType) &&
        Objects.equals(this.currencyCode, instrumentDetail.currencyCode) &&
        Objects.equals(this.defaultAmount, instrumentDetail.defaultAmount) &&
        Objects.equals(this.defaultSlippage, instrumentDetail.defaultSlippage) &&
        Objects.equals(this.defaultSlippageType, instrumentDetail.defaultSlippageType) &&
        Objects.equals(this.description, instrumentDetail.description) &&
        Objects.equals(this.exchange, instrumentDetail.exchange) &&
        Objects.equals(this.format, instrumentDetail.format) &&
        Objects.equals(this.groupId, instrumentDetail.groupId) &&
        Objects.equals(this.incrementSize, instrumentDetail.incrementSize) &&
        Objects.equals(this.isBarrierEqualsStrike, instrumentDetail.isBarrierEqualsStrike) &&
        Objects.equals(this.isComplex, instrumentDetail.isComplex) &&
        Objects.equals(this.isExtendedTradingHoursEnabled, instrumentDetail.isExtendedTradingHoursEnabled) &&
        Objects.equals(this.isPEAEligible, instrumentDetail.isPEAEligible) &&
        Objects.equals(this.isPEASMEEligible, instrumentDetail.isPEASMEEligible) &&
        Objects.equals(this.isRedemptionByAmounts, instrumentDetail.isRedemptionByAmounts) &&
        Objects.equals(this.isSwitchBySameCurrency, instrumentDetail.isSwitchBySameCurrency) &&
        Objects.equals(this.isTradable, instrumentDetail.isTradable) &&
        Objects.equals(this.lotSizeType, instrumentDetail.lotSizeType) &&
        Objects.equals(this.minimumTradeSize, instrumentDetail.minimumTradeSize) &&
        Objects.equals(this.nonTradableReason, instrumentDetail.nonTradableReason) &&
        Objects.equals(this.orderDistances, instrumentDetail.orderDistances) &&
        Objects.equals(this.priceCurrency, instrumentDetail.priceCurrency) &&
        Objects.equals(this.priceToContractFactor, instrumentDetail.priceToContractFactor) &&
        Objects.equals(this.primaryListing, instrumentDetail.primaryListing) &&
        Objects.equals(this.relatedInstruments, instrumentDetail.relatedInstruments) &&
        Objects.equals(this.shortTradeDisabled, instrumentDetail.shortTradeDisabled) &&
        Objects.equals(this.standardAmounts, instrumentDetail.standardAmounts) &&
        Objects.equals(this.supportedOrderTriggerPriceTypes, instrumentDetail.supportedOrderTriggerPriceTypes) &&
        Objects.equals(this.supportedOrderTypes, instrumentDetail.supportedOrderTypes) &&
        Objects.equals(this.supportedStrategies, instrumentDetail.supportedStrategies) &&
        Objects.equals(this.symbol, instrumentDetail.symbol) &&
        Objects.equals(this.tickSizeScheme, instrumentDetail.tickSizeScheme) &&
        Objects.equals(this.tradableAs, instrumentDetail.tradableAs) &&
        Objects.equals(this.tradableOn, instrumentDetail.tradableOn) &&
        Objects.equals(this.tradingSignals, instrumentDetail.tradingSignals) &&
        Objects.equals(this.tradingStatus, instrumentDetail.tradingStatus) &&
        Objects.equals(this.uic, instrumentDetail.uic);
  }

  @Override
  public int hashCode() {
    return Objects.hash(affiliateInfoRequired, amountDecimals, assetType, currencyCode, defaultAmount, defaultSlippage, defaultSlippageType, description, exchange, format, groupId, incrementSize, isBarrierEqualsStrike, isComplex, isExtendedTradingHoursEnabled, isPEAEligible, isPEASMEEligible, isRedemptionByAmounts, isSwitchBySameCurrency, isTradable, lotSizeType, minimumTradeSize, nonTradableReason, orderDistances, priceCurrency, priceToContractFactor, primaryListing, relatedInstruments, shortTradeDisabled, standardAmounts, supportedOrderTriggerPriceTypes, supportedOrderTypes, supportedStrategies, symbol, tickSizeScheme, tradableAs, tradableOn, tradingSignals, tradingStatus, uic);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstrumentDetail {\n");
    ...
    sb.append("    shortTradeDisabled: ").append(toIndentedString(shortTradeDisabled)).append("\n");
